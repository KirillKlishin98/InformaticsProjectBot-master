...
public class TestRUCommand extends ServiceCommand {
    private Logger logger = LoggerFactory.getLogger(EnglishWordCommand.class);

    public TestRUCommand(String identifier, String description) {
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
        ...
        sendAnswerTest(absSender, chat.getId(), OperationEnum.TEST_RU, this.getDescription(),
